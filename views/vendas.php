                    ...
                    if (vendasCardsMobile) {
                        ...
                        card.innerHTML = `
                            <div class="flex justify-between items-start mb-3">
                                ...
                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${badgeClass} whitespace-nowrap ml-2">${formatStatusText(venda.status_pagamento)}</span>
                            </div>
                            ...
                            <div class="flex items-center justify-end space-x-2 pt-3 border-t border-dark-border">
                                <a href="${whatsappLink}" target="_blank" class="${whatsappClass} p-2 rounded-lg bg-dark-card hover:bg-dark-elevated transition" title="WhatsApp">
